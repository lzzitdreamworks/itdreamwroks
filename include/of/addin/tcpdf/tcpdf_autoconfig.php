...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'examples/img/', K_PATH_MAIN.'img/', '/usr/share/doc/php-tcpdf/examples/img/', '/usr/share/doc/tcpdf/examples/img/', '/usr/share/doc/php/tcpdf/examples/img/', '/var/www/tcpdf/img/', '/var/www/html/tcpdf/img/', '/usr/local/apache2/htdocs/tcpdf/img/', K_PATH_MAIN);
