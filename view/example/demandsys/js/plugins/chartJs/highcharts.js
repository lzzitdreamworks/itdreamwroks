...
//	alert("温馨提示:当前浏览器不能完整浏览系统，请使用高版本的IE浏览器打开,或在谷歌、火狐、360（极速模式）、QQ等其它浏览器中打开");
...
if (isIE = navigator.userAgent.indexOf("MSIE") != -1) {
	...
	(function(E, X) {
		...
		B.stop = Oa;
		N = {
			colors: "#ffbf7a,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
